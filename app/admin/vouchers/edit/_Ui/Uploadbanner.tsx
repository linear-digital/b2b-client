...
const Uploadbanner = ({ image, setImage, publicImg }: { image: any, setImage: any, publicImg: string }) => {
    ...
    return (
        <div>
            <div
                ...
                style={{
                    backgroundImage:  `url(${previewUrl || publicImg})`,
            ...
            {
               ( publicImg || previewUrl) && <div className='mt-5 flex justify-start'>
